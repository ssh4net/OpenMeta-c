...
typedef enum omc_entry_name_ctx_kind {
    ...
    OMC_ENTRY_NAME_CTX_SIGMA_MAIN_COMPAT = 22,
    OMC_ENTRY_NAME_CTX_NIKON_MAIN_Z = 23,
    OMC_ENTRY_NAME_CTX_NIKON_MAIN_COMPACT_TYPE2 = 24,
    OMC_ENTRY_NAME_CTX_NIKON_FLASHINFO_GROUPS = 25,
    OMC_ENTRY_NAME_CTX_NIKON_FLASHINFO_LEGACY = 26,
    OMC_ENTRY_NAME_CTX_SONY_MAIN_COMPAT = 27,
    OMC_ENTRY_NAME_CTX_CANON_COLORDATA7_PSINFO2 = 28
