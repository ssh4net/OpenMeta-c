...
typedef enum omc_metadata_patch_code {
    ...
    /* Appended in contract v1. Existing numeric values remain stable. */
    OMC_METADATA_PATCH_ENTRY_NOT_SERIALIZABLE,
    OMC_METADATA_PATCH_VALUE_ALIASES_INSTANCE,
    OMC_METADATA_PATCH_UNSUPPORTED_SHAPE,
    OMC_METADATA_PATCH_AMBIGUOUS_PROPERTY,
    OMC_METADATA_PATCH_NULL_REPLAY_CALLBACK
